...
SHOP_ITEMS = {
    ...
    'daily_reset':   {'name': 'Daily Reset',    'description': 'Reset your daily cooldown (Single Use)',  'duration': None},
    'work_reset':    {'name': 'Work Reset',     'description': 'Reset your work cooldown (Single Use)',   'duration': None},
...
# ─────────────────────────────────────────────────────────────────────────────
# CASINO CONFIG  – Reworked casino system
# ─────────────────────────────────────────────────────────────────────────────

# ── Branding ─────────────────────────────────────────────────────────────────
BOT_NAME          = "Tainment"         # ← change to your bot name
CURRENCY_NAME     = "Bits"             # ← change e.g. "Credits" / "Gold"
...
CASINO_FOOTER     = "Tainment+ Casino"   # embed footer text
...
CASINO = {
    ...
    "wheel_segments": [
        ...
        {"label": "1.2×",     "emoji": "🔄", "multiplier": 1.2,  "weight": 22},
