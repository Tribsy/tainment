"""
cogs/moderation/commands.py — Moderation cog (warn/kick/ban/timeout/purge/etc.).

Phase 3e: extracted verbatim from cogs/moderation/__init__.py. Command logic
in this file calls service.py helpers for DB writes and log delivery.
"""
import asyncio
import discord
...
logger = logging.getLogger("tainment.moderation.commands")
