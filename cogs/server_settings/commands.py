"""
cogs/server_settings/commands.py — ServerSettings cog: server-config commands.

Phase 3c: extracted verbatim from cogs/server_settings/__init__.py. Holds the
slash + prefix command surface. DB helpers live in service.py; constants in
constants.py.
"""
import discord
...
from .service import *  # noqa: F401, F403  (re-exports all 19 helpers)

logger = logging.getLogger("tainment.server_settings.commands")
