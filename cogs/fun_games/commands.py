"""
cogs/fun_games/commands.py — FunGames cog (typerace, riddle, wyr, emojidecode, etc.).

Phase 3h: extracted verbatim from cogs/fun_games/__init__.py. No helpers or
views in this cog — it's pure commands + the data banks in constants.py.
"""
import discord
...
from .constants import TYPERACE_SENTENCES, RIDDLES, WYR_PAIRS, EMOJI_PHRASES, CHAIN_STARTERS

logger = logging.getLogger("tainment.fun_games.commands")
